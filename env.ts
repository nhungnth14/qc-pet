...
const envSchema = z.object({
  ...
  EXPO_PUBLIC_SENTRY_DSN: z.string().optional(), // DSN không phải secret cứng; trống = tắt Sentry
...
const BUNDLE_IDS = {
  development: 'com.qcpet.development',
  preview: 'com.qcpet.preview',
  production: 'com.qcpet',
} as const;
...
const SCHEMES = {
  development: 'qcPetApp',
  preview: 'qcPetApp.preview',
  production: 'qcPetApp',
} as const;
